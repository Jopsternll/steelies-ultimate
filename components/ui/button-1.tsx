...
const buttonVariants = cva(
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    ...
    compoundVariants: [
      ...
      {
        variant: 'primary', mode: 'link', underline: 'solid',
      ...
      {
        variant: 'primary', mode: 'link', underline: 'dashed',
      ...
      {
        variant: 'primary', mode: 'link', underlined: 'solid',
      ...
      {
        variant: 'primary', mode: 'link', underlined: 'dashed',
      ...
      {
        variant: 'inverse', mode: 'link', underline: 'solid',
      ...
      {
        variant: 'inverse', mode: 'link', underline: 'dashed',
      ...
      {
        variant: 'inverse', mode: 'link', underlined: 'solid',
      ...
      {
        variant: 'inverse', mode: 'link', underlined: 'dashed',
      ...
      {
        variant: 'foreground', mode: 'link', underline: 'solid',
      ...
      {
        variant: 'foreground', mode: 'link', underline: 'dashed',
      ...
      {
        variant: 'foreground', mode: 'link', underlined: 'solid',
      ...
      {
        variant: 'foreground', mode: 'link', underlined: 'dashed',
